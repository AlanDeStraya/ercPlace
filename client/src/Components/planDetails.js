...
const PlanDetails = ({ diversionState, openBoxes }) => {
    ...
    return (
      <div id='plan-details'>
        {openBoxes.pic && <div id='graphic'>{diversionState.planNumber === '' ? <p>No plan available</p> : <img src={`./resources/images/plan${diversionState.planNumber.replace('.', 'p')}.png`} alt=''></img>}</div>}
